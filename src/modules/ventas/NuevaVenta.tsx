...
export function NuevaVenta() {
  ...
  const setPaymentMethod = (payload: 'EFECTIVO' | 'TARJETA') => dispatch({ type: 'SET_PAYMENT_METHOD', payload });
  const setAmountPaid = (payload: string) => dispatch({ type: 'SET_AMOUNT_PAID', payload });
