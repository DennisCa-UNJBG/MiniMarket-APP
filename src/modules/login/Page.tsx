...
export function Login({ onLogin }: LoginProps) {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-zinc-50 dark:bg-zinc-900 overflow-hidden relative">
      {/* ── Elementos decorativos de fondo ──────────────────────────────────── */}
      <div className="absolute top-[-10%] left-[-10%] size-96 bg-blue-500/20 rounded-full blur-3xl opacity-50 dark:opacity-20 animate-pulse"></div>
      <div className="absolute bottom-[-10%] right-[-10%] size-[30rem] bg-violet-500/20 rounded-full blur-3xl opacity-50 dark:opacity-20 animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="relative w-full max-w-5xl h-[600px] bg-white/80 dark:bg-zinc-800/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/20 dark:border-zinc-700/50 flex z-10 m-4">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-violet-700 p-12 flex-col justify-between relative overflow-hidden text-white">
          ...
          <div className="relative z-10">
            <h2 className="text-4xl font-semibold mb-4 leading-tight">
              Gestiona tu inventario con <span className="text-blue-200">inteligencia</span>.
            </h2>
        ...
        <div className="w-full lg:w-1/2 p-8 sm:p-12 md:p-16 flex flex-col justify-center">
          <div className="max-w-md w-full mx-auto space-y-8">
            ...
            <div>
              <h3 className="text-2xl sm:text-3xl font-semibold text-zinc-900 dark:text-white">Bienvenido de nuevo</h3>
